...
function LoginPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Вхід до особистого кабінету | Omega Auto</title>
        <meta
          name="description"
          content="Увійдіть до свого акаунту Omega Auto, щоб керувати оголошеннями та профілем."
        />
      </Helmet>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 relative">
        <div className="w-full max-w-md sm:p-8 p-6 bg-white rounded-lg shadow-lg relative">
          <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 text-center text-sm flex space-x-1 items-center whitespace-nowrap">
