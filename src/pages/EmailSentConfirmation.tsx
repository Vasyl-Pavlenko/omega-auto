...
export default function EmailSentConfirmationPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-4 text-center">
      <h1 className="text-3xl font-bold mb-3 text-gray-800">Підтвердіть вашу електронну адресу</h1>
      ...
      <p className="text-sm text-gray-600 mb-6 max-w-md">
        Якщо ви не отримали листа, перевірте папку "Спам" або натисніть кнопку нижче, щоб надіслати
        ще раз.
      </p>
